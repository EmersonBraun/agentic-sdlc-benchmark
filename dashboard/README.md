...
The current MVP is a dependency-free static page in [`index.html`](index.html). It reads [`../adapters/preflight-v1.1.json`](../adapters/preflight-v1.1.json) and [`../adapters/condition-readiness-v1.1.json`](../adapters/condition-readiness-v1.1.json), falls back to a bounded blocked state when data is unavailable, and adds no analytics or user tracking.
