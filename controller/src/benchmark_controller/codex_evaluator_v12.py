...
class CodexEvaluatorV12RoleExecutor:
    ...
    def _prompt(
        ...
        return (
            ...
            "evidence. For review, explicitly report every inspectable gate supported by the "
            "repository, including review, documentation, and migrations when the inspected "
            "diff and repository state support them. Never claim ledger or essential-hidden-tests; "
            "those require controller-owned evidence outside this worktree. Inspectable gates are: "
