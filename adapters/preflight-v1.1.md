...
| Compozy 0.3.0-beta.16 | installed-not-ready | Local workspace/session creation and cleanup; candidate model connectivity | Provider-bound `gpt-5.4` session and lifecycle ledger bridge are unverified |
