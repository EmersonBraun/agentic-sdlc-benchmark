...
See [`catalog-v1.0.json`](catalog-v1.0.json), [`preflight-v1.0.json`](preflight-v1.0.json), and the controller adapter contract in [`../controller/src/benchmark_controller/adapters.py`](../controller/src/benchmark_controller/adapters.py).
